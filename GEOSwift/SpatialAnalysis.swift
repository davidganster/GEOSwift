...
public extension Geometry {
    ...
    /// - returns: A Polygon that represents all points whose distance from this geometry is less than or equal to the given width, with the given endCapStyle and joinStyle.
